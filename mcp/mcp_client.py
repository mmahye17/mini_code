"""
MCP System — late-bound external tool discovery.

MCP is modeled as late-bound tools: connect first, then discovered
server tools are merged into the normal tool pool with mcp__server__tool names.
"""

from shared.config import normalize_mcp_name


# MCP clients registry (server_name → MCPClient)
