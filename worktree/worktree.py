"""
Worktree System — isolated git worktrees for task isolation.

Worktree names become filesystem paths. Validation rules are strict
and reused for create/remove/keep operations.
"""
...
from shared.config import WORKDIR, WORKTREES_DIR, VALID_WT_NAME
from tasks.task_system import load_task, bind_task_to_worktree
